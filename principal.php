          ...
          <nav class="navbar navbar-expand-lg navbar-light " style=" border-radius: 1em; background:  #E0DEDE;" >
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
              ...
              <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
               	 <li class="logo">
                  <img src="img/logoufps.jpg" width="60px" height="60px" style="margin-left: 20px;">
                ...
                <li class="nav-item active" style="margin-top: 30px;">
                    ...
                    <img src="img/add.png"  style="border-radius: 1em; height: 40px; width:40px; margin-left: 50px;">


                   <center> <span class="nav-link" style="margin-top: -12px; height: 1px; color: black; margin-left: 40px;" > Add</span></center>
                  </a>
                </li>
...
<form action="registrarencuesta.php" method="POST" class="login">
                  <li class="nav-item active"  style="margin-top: 30px;">
  ...
  <form action="registraroferta.php" method="POST" class="login">
                  <li class="nav-item active"  style="margin-top: 30px;">
                ...
                <li class="nav-item active">
                  <a class="nav-link" href="#">
                   ...
                   <center> <span class="nav-link" style="margin-top: -12px; height: 1px; " > nombre del egresado</span></center>
                  </a>
                </li>
